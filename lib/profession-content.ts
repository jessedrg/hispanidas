...
export const PROFESSION_CONTENT: Record<string, ProfessionContent> = {
  ...
  fontanero: {
    ...
    seoText: "En Hispanidas somos fontaneros profesionales en toda España. Fontanero urgente, fontanero 24 horas, fontanero de emergencia, fontanero economico y fontanero de confianza en tu zona. Especializados en detección de fugas sin obra, reparación de tuberías, instalación de grifería, cisternas, calentadores, termos eléctricos y fontanería para reformas. Utilizamos cámaras térmicas, equipos de correlación acústica y gas trazador. Fontanero cerca de mí, fontanero a domicilio, fontanero rápido y fontanero certificado en más de 8.000 localidades. Presupuesto cerrado y garantía por escrito.",
    emergencyTips: [
  ...
  cerrajero: {
    heroSubtitle:
      "Cerrajeros profesionales para aperturas, cambios de cerradura, sistemas antibumping y seguridad avanzada. Trabajamos sin dañar tu puerta. Servicio discreto y con garantia.",
    whatWeDo:
    ...
    howWeWork: [
      ...
      "Te enviamos un cerrajero de tu zona con nombre, hora estimada y rango de precio.",
    ...
    seoText: "En Hispanidas somos cerrajeros profesionales en toda España. Cerrajero urgente, cerrajero 24 horas, cerrajero de emergencia, cerrajero economico y cerrajero de confianza. Especializados en aperturas sin daños, cambios de cerradura, cerraduras antibumping, puertas blindadas y acorazadas, cerraduras inteligentes y servicio post-robo. Trabajamos con Keso, Ezcurra, Lince, Tesa, Yale, Iseo, Mottura y Mul-T-Lock. Cerrajero cerca de mí, cerrajero a domicilio, cerrajero rápido y cerrajero certificado en más de 8.000 localidades. Precio cerrado y garantía del fabricante.",
    emergencyTips: [
  ...
  desatascos: {
    heroSubtitle:
      "Servicio profesional de desatascos con maquinaria industrial: camiones cuba, equipos de alta presion, camaras CCTV y fresadoras mecanicas. Desatascamos tuberias, arquetas, bajantes y fosas septicas.",
    whatWeDo:
      "Somos especialistas en desatascos y limpieza de tuberias. Diagnosticamos con camaras CCTV para ver exactamente que ocurre dentro de la tuberia antes de intervenir. Usamos equipos de alta presion (200-400 bar), fresadoras mecanicas e hidrolimpiadoras. Para trabajos mayores disponemos de camiones cuba de diferentes capacidades.",
    howWeWork: [
    ...
    seoText: "En Hispanidas somos especialistas en desatascos profesionales en toda España. Desatascos urgentes, desatascos 24 horas, desatascos de emergencia y desatascos economicos. Desatascamos tuberías, inodoros, fregaderos, duchas, bajantes, arquetas, colectores y fosas sépticas. Equipos de alta presión, fresadoras mecánicas, cámaras CCTV y camiones cuba. Desatascos cerca de mí, desatascos a domicilio y desatascos rápidos en más de 8.000 localidades. Desatasco garantizado.",
    emergencyTips: [
  ...
  calderas: {
    heroSubtitle:
      "Tecnicos de calderas certificados por los principales fabricantes para revision, reparacion, instalacion y sustitucion. Calderas de gas, gasoil y aerotermia. Mantenimiento preventivo con garantia.",
    whatWeDo:
    ...
    howWeWork: [
      ...
      "Te asignamos un tecnico certificado de tu zona, especializado en tu marca.",
    ...
    seoText: "En Hispanidas somos técnicos de calderas certificados en toda España. Revisión de calderas, reparación de calderas urgente, instalación de calderas de condensación, sustitución de calderas antiguas, mantenimiento de radiadores y aerotermia. Trabajamos con Junkers/Bosch, Vaillant, Saunier Duval, Baxi, Ferroli, Cointra y Ariston. Técnico de calderas cerca de mí, reparación de calderas rápida y mantenimiento profesional en más de 8.000 localidades. Piezas originales, presupuesto cerrado y garantía por escrito.",
    emergencyTips: [
