  ...
  return (
    <main className="min-h-[60vh] flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <h1 className="text-2xl font-bold text-gray-900 mb-3">Pagina no encontrada</h1>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <a
            href={`tel:${PHONE}`}
            className="px-6 py-3 rounded-full bg-accent-500 hover:bg-accent-600 text-white font-semibold transition-colors"
          >
