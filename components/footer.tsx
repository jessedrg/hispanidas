        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          <div className="lg:col-span-1">
            ...
            <p className="text-sm text-gray-400 leading-relaxed mb-6">
              Profesionales cualificados para tu hogar. Servicio garantizado en toda Espana.
            </p>
            <div className="flex items-center gap-3">
              <a
                href={`tel:${PHONE}`}
                className="btn-primary inline-flex items-center gap-2 text-white px-5 py-2.5 rounded-full text-sm font-semibold"
              >
          ...
          <div>
            <h3 className="text-white font-semibold mb-4 text-sm uppercase tracking-wider">Ciudades principales</h3>
            <ul className="space-y-3">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="text-sm text-gray-400">Toda Espana</li>
            </ul>
